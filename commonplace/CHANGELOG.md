...
Template-level history (what changed in Commonplace itself, not in any instance). Newest first.
...
(`gen-related`, `apply.py`, `scrub-check`) flowed to the sibling templates through the Chandlery
registry.
