...
Commonplace is the workspace member of the FAW template family (siblings: **Lodestar**, the
shared-context store `SHARED_CONTEXT_PATH` points at; **Chandlery**, the capability registry this
